...
import { ActionSocket, TextSocket } from "./app/sockets";
import { Schemes } from "./app/types";
import { Connection } from "./app/connection";
import { ActionSocketComponent } from "./app/ui/ActionSocket";
import { TextSocketComponent } from "./app/ui/TextSocket";
import { ActionConnectionComponent } from "./app/ui/ActionConnection";
import { TextConnectionComponent } from "./app/ui/TextConnection";
import { ChatNodeComponent } from "./app/ui/Chat";
import { CustomNodeComponent } from "./app/ui/CustomNode";
import { getConnectionSockets } from "./app/utils";
import { addCustomBackground } from "./app/ui/background";
import * as ContextMenuComponents from "./app/ui/context-menu";
...
export async function createEditor(
  ...
  chat.botSend(
    "Hello there! I'm a app based on visual programming and built using the Rete.js framework"
  );
